    ...
    <ProtectedPage>
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          ...
          <Card>
            <h2 className="text-base font-semibold text-slate-950">Delivery volume import</h2>
            <p className="mt-2 text-sm text-slate-600">POST JSON records to:</p>
            <pre className="mt-3 rounded-md bg-slate-950 p-3 text-sm text-slate-100">/api/import/delivery-volume</pre>
          </Card>
          <Card>
            <h2 className="text-base font-semibold text-slate-950">Pickup volume import</h2>
            <p className="mt-2 text-sm text-slate-600">POST JSON records to:</p>
            <pre className="mt-3 rounded-md bg-slate-950 p-3 text-sm text-slate-100">/api/import/pickup-volume</pre>
          </Card>
          <Card>
            <h2 className="text-base font-semibold text-slate-950">Pickup PUP route import</h2>
            <p className="mt-2 text-sm text-slate-600">POST assign_log PUP records to:</p>
            <pre className="mt-3 rounded-md bg-slate-950 p-3 text-sm text-slate-100">/api/import/pickup-assignments</pre>
          </Card>
        </div>
        <Card>
